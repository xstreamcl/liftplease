...
public class RequestLiftActivity extends ActionBarActivity{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_request_lift, menu);
...
//    }
    ...
    public void requestLift(){
        new MyAsyncTask().execute(providerId, session_id);
    }
    ...
    private class MyAsyncTask extends AsyncTask<String, Integer, String>{
        ...
        protected String doInBackground(String... params) {
            ...
            HttpPost httppost = new HttpPost("http://whenisdryday.in:5000/subscriber/request");

            List nameValuedPairs = new ArrayList();
            nameValuedPairs.add(new BasicNameValuePair("provider", params[0]));
